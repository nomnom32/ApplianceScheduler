...
%find a way to addd up all the orig_ev_op for the whole file as you go
%along
orig_total2 = orig_ev_op+orig_appenergy;
%orig_total2

%final_cost = sum(transpose(orig_total2.*price(price_code,:)),1); %computation of final cost for consumer
